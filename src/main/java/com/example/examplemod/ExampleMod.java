...
public final class ExampleMod extends gregapi.api.Abstract_Mod {
	...
	public static final String MOD_ID = "modid"; // <-- TODO: you need to change this to the ID of your own Mod, and then remove this Comment after you did that.
	...
	@cpw.mods.fml.common.SidedProxy(modId = MOD_ID, clientSide = "com.example.examplemod.ProxyClient", serverSide = "com.example.examplemod.ProxyServer")
	...
	public void onModPreInit2(cpw.mods.fml.common.event.FMLPreInitializationEvent aEvent) {
		...
		tExamplium.add(gregapi.data.TD.Processing.SMITHABLE); // This Material is smithable like regular Metal things.
		tExamplium.add(gregapi.data.TD.Processing.MELTING); // This Material can melt.
		tExamplium.add(gregapi.data.TD.Processing.FURNACE); // This Material can be molten in a regular Furnace.
		tExamplium.add(gregapi.data.TD.Processing.CENTRIFUGE); // This Material can be centrifuged to recycle it.
		tExamplium.add(gregapi.data.TD.Compounds.DECOMPOSABLE); // This Material can be decomposed in general.
		tExamplium.add(gregapi.data.TD.ItemGenerator.G_INGOT_MACHINE_ORES); // This Material is a typical Ingot, that can be used for Machine Parts, and the Material can be found as Ore too.
		tExamplium.setStatsEnergetic(2000, 4000); // This Material melts at 2000 Kelvin and Boils at 4000 Kelvin.
		tExamplium.setQuality(6.0F, 512, 3); // The Speed is 6.0F what is as fast as Steel at mining stuff, the Durability is 512 what equals Steel too, and the Quality is 3 for Diamond Tool Level.
		tExamplium.setMcfg(0, gregapi.data.MT.Steel, 1*gregapi.data.CS.U); // This Material consists out of one Unit of Steel.
		tExamplium.setOriginalMod(MOD_ID, MOD_NAME); // Gives your Mod the credit for creating this Material.
	...
	public void onModInit2(cpw.mods.fml.common.event.FMLInitializationEvent aEvent) {
		...
		gregapi.tileentity.connectors.MultiTileEntityPipeFluid.addFluidPipes(30, 0, 250, true, true, false, true, false, true, tExampleRegistry, tMachineBlock, gregapi.tileentity.connectors.MultiTileEntityPipeFluid.class, tExamplium);
		...
		gregapi.tileentity.connectors.MultiTileEntityPipeItem.addItemPipes(100, 0, 32768, 1, true, tExampleRegistry, tMetalBlock, gregapi.tileentity.connectors.MultiTileEntityPipeItem.class, gregapi.data.MT.Fe);
